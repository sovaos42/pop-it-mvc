...
<div class="container">
    <div class="body">
        ...
        <label class="ID">Отчество<input type="text"  name="patronmic"></label>
        <label class="ID">Пол<input type="text"  name="sex"></label>
        ...
        <label class="ID">ID сотрудника<input type="text"  name="IDEmployees"></label>
        <label class="ID">Подразделение<input type="text"  name="IDSubdivision"></label>
        <label class="ID">Дисциплина<input type="text"  name="IDDiscipline"></label>
        <label class="ID">Логин<input type="text"  name="login"></label>
        <label class="ID">Пароль<input type="text"  name="password"></label>
